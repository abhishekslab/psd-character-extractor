...
setup(
    ...
    version=get_version(),
    author="abhishekslab",
    author_email="abhishekslab@users.noreply.github.com",
    description="Automated character extraction from Photoshop PSD files for VTubers and game development",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/abhishekslab/psd-character-extractor",
    project_urls={
        "Bug Tracker": "https://github.com/abhishekslab/psd-character-extractor/issues",
        "Documentation": "https://github.com/abhishekslab/psd-character-extractor/blob/main/README.md",
        "Source Code": "https://github.com/abhishekslab/psd-character-extractor",
    },
